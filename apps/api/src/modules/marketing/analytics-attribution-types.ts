// apps/api/src/modules/marketing/analytics-attribution-types.ts
// EDDIE 11.16.19 — Canonical Types for Analytics, Multi-Channel Attribution, Evidence-based Insights and Reports
