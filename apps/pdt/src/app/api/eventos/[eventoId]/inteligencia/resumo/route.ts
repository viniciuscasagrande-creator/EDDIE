...
export async function GET(
  ...
  return NextResponse.json({
    ...
    fontesSincronizadas: [
      { subsistema: 'Vendas & Checkout', status: 'ONLINE', latenciaMs: 38, ultimaSincronizacao: agora },
      { subsistema: 'Inventário de Lotes', status: 'ONLINE', latenciaMs: 25, ultimaSincronizacao: agora },
      { subsistema: 'Portaria & Scanners', status: 'ONLINE', latenciaMs: 110, ultimaSincronizacao: agora },
      { subsistema: 'Gateway Pagamentos', status: 'ONLINE', latenciaMs: 64, ultimaSincronizacao: agora },
      { subsistema: 'Financeiro & Conciliação', status: 'ONLINE', latenciaMs: 82, ultimaSincronizacao: agora },
      { subsistema: 'Marketing & Conversões', status: 'ONLINE', latenciaMs: 195, ultimaSincronizacao: agora },
      { subsistema: 'Central de Incidentes', status: 'ONLINE', latenciaMs: 20, ultimaSincronizacao: agora },
    ],
    real: {
